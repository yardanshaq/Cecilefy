...
const spec = {
  ...
  SITE_NAME: str({ example: "Cecilefy", default: "Cecilefy" }),
  DEFAULT_DOMAIN: str({ example: "cecilefy.xyz", default: "localhost:3000" }),
  ...
  MAIL_FROM: str({ default: "", example: "Cecilefy <gg@yardansh.xyz>" }),
